# Generated by Django 3.2.5 on 2021-08-08 01:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('developer', 'Developer'), ('assessor', 'Assessor'), ('admin', 'Admin')], default='admin', max_length=50, verbose_name='Tipo de Usuário')),
                ...
                ('sex', models.CharField(choices=[('M', 'Masculino'), ('F', 'Feminino')], default='F', max_length=10, verbose_name='Sexo')),
                ('telefone', models.CharField(blank=True, max_length=25, null=True, verbose_name='Telefone')),
                ('email', models.EmailField(blank=True, max_length=150, null=True, unique=True, verbose_name='E-mail')),
