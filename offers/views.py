...
def addFii(request):
    ...
    row = [
            ...
            request.POST['periodo_de_negociacao_inicial'],
            request.POST['periodo_de_negociacao_final'],
            request.POST['periodo_de_preferencia_inicial'],
            request.POST['periodo_de_preferencia_final'],
            request.POST['periodo_de_sobras_inicial'],
            request.POST['periodo_de_sobras_final'],
            request.POST['perio_do_publico_inicial'],
            request.POST['perio_do_publico_final'],
