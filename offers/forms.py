...
class FiiForm(forms.Form):
    ...
    periodo_de_negociacao_inicial = forms.DateField(label="Período de Negociação (Inicial)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    periodo_de_negociacao_final = forms.DateField(label="Período de Negociação (Final)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    periodo_de_preferencia_inicial = forms.DateField(label="Período de Preferência (Inicial)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    periodo_de_preferencia_final = forms.DateField(label="Período de Preferência (Final)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    periodo_de_sobras_incial = forms.DateField(label="Período de Sobras (Inicial)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    periodo_de_sobras_final = forms.DateField(label="Período de Sobras (Final)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    perio_do_publico_inicial = forms.DateField(label="Período Público (Inicial)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    perio_do_publico_final = forms.DateField(label="Período Público (Final)", widget=forms.TextInput(attrs={'type':'date'}), required=False)
    ...
    proporcao_de_preferencia = forms.CharField(label="Proporção de Preferência", max_length=20, widget=forms.TextInput(attrs={'onkeyup':'formatPercent(this)'}), required=False)
    proporcaode_sobras = forms.CharField(label="Proporção de Sobras", max_length=20, widget=forms.TextInput(attrs={'onkeyup':'formatPercent(this)'}), required=False)
